...
export const OrderNotificationEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Payment Confirmed for Order: {orderNumber}</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={header}>
            <Text style={logo}>🍽️ ChopTym</Text>
            <Text style={tagline}>Admin Payment Notification</Text>
          </Section>
          ...
          <Section style={paymentConfirmedSection}>
            <Text style={paymentConfirmedText}>
              ✅ Payment has been confirmed and the order is ready to be prepared.
            </Text>
          </Section>
