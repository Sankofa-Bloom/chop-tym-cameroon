    ...
    >
      <Card className="overflow-hidden hover:shadow-strong transition-all duration-300 cursor-pointer border-0 bg-card/50 backdrop-blur-sm">
        ...
        >
          ...
          >
            <Badge className="absolute top-3 left-3 bg-primary/90 text-primary-foreground hover:bg-primary shadow-soft backdrop-blur-sm">
              {dish.category}
            </Badge>
          </motion.div>
        ...
        <CardContent className="p-4 sm:p-6">
          ...
          >
            <div>
              <h3 className="font-heading font-semibold text-lg sm:text-xl mb-2 text-balance group-hover:text-primary transition-colors duration-300">
                {dish.name}
              </h3>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              >
                <Button 
                  ...
                  className="bg-primary hover:bg-primary-dark text-primary-foreground shadow-soft hover:shadow-medium transition-all duration-300"
                  size="sm"
                >
                  View Details
                </Button>
